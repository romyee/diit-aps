...
class ApplicationFormsControllerTest < ActionController::TestCase
  ...
  test "should create application_form" do
    assert_difference('ApplicationForm.count') do
      post :create, application_form: { comment: @application_form.comment, status: @application_form.status, tracking_id: @application_form.tracking_id }
    end
  ...
  test "should update application_form" do
    put :update, id: @application_form, application_form: { comment: @application_form.comment, status: @application_form.status, tracking_id: @application_form.tracking_id }
    assert_redirected_to application_form_path(assigns(:application_form))
  end
