...
class FormFieldsControllerTest < ActionController::TestCase
  ...
  test "should create form_field" do
    assert_difference('FormField.count') do
      post :create, form_field: { answer_opitons: @form_field.answer_opitons, answer_type: @form_field.answer_type, description: @form_field.description, label: @form_field.label, mandetory: @form_field.mandetory }
    end
  ...
  test "should update form_field" do
    put :update, id: @form_field, form_field: { answer_opitons: @form_field.answer_opitons, answer_type: @form_field.answer_type, description: @form_field.description, label: @form_field.label, mandetory: @form_field.mandetory }
    assert_redirected_to form_field_path(assigns(:form_field))
  end
